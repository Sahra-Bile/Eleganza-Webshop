...
let inputMessage: HTMLTextAreaElement = document.getElementById(
  "message"
...
let erroNodes: HTMLFormElement = document.getElementById(
  "error"
) as HTMLFormElement;

let success: HTMLParagraphElement = document.getElementById(
  "success"
